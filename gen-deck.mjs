...
s.addShape(p.ShapeType.line,{x:1.3,y:3.05,w:10.7,h:0,line:{color:LEAF,width:1.25,transparency:45}});
...
phasesX.forEach((ph,i)=>{
  const x=1.0+i*3.9;
  s.addShape(p.ShapeType.ellipse,{x:x+1.62,y:2.92,w:0.26,h:0.26,fill:{color:GOLD}});
  s.addShape(p.ShapeType.roundRect,{x,y:3.4,w:3.5,h:2.0,rectRadius:0.14,fill:{color:WHITE,transparency:93},line:{color:WHITE,width:0.75,transparency:82}});
  s.addText(ph[0],{x:x+0.3,y:3.6,w:2.9,h:0.26,fontFace:BF,fontSize:10,bold:true,charSpacing:1.6,color:GOLD});
  s.addText(ph[1],{x:x+0.3,y:3.9,w:2.9,h:0.6,fontFace:HF,fontSize:15,bold:true,color:WHITE,lineSpacing:19});
  s.addText(ph[2],{x:x+0.3,y:4.55,w:2.9,h:0.75,fontFace:BF,fontSize:11,color:WHITE,transparency:35,lineSpacing:15});
});
...
s.addText([{text:"Working field setup ",options:{color:WHITE}},{text:"→ ",options:{color:GOLD}},{text:"validated advisories ",options:{color:WHITE}},{text:"→ ",options:{color:GOLD}},{text:"scalable deployment",options:{color:WHITE}}],{x:6.9,y:6.02,w:5.43,h:0.72,align:"right",valign:"middle",fontFace:BF,fontSize:11.5,transparency:18});
footer(s,10,true);
...
res.forEach((r,i)=>{
  const x=1.0+(i%3)*2.6, y=2.78+Math.floor(i/3)*1.32;
  card(s,{x,y,w:2.4,h:1.15});
  iconBadge(s,{x:x+0.24,y:y+0.2,d:0.4,kind:r[2]});
  s.addText(r[0],{x:x+0.7,y:y+0.22,w:1.6,h:0.34,fontFace:BF,fontSize:10.5,bold:true,charSpacing:0.8,color:FOREST});
  s.addText(r[1],{x:x+0.24,y:y+0.66,w:2.0,h:0.42,fontFace:BF,fontSize:10,color:CHAR,transparency:32,lineSpacing:13});
});
...
s.addShape(p.ShapeType.roundRect,{x:1.0,y:5.52,w:7.6,h:1.0,rectRadius:0.14,fill:{color:LEAF,transparency:90},line:{color:LEAF,width:0.75,transparency:60}});
s.addText("BEYOND HARDWARE",{x:1.28,y:5.66,w:3,h:0.22,fontFace:BF,fontSize:9,bold:true,charSpacing:1.4,color:LEAF});
s.addText("Student development effort, dataset collection from the pilot field, and college lab support for testing and validation.",{x:1.28,y:5.9,w:7.0,h:0.5,fontFace:BF,fontSize:12,color:CHAR,transparency:22,lineSpacing:16});
...
s.addText("11 — EXPECTED OUTCOMES, IMPACT & CONCLUSION",{x:1.1,y:1.15,w:8,h:0.3,fontFace:BF,fontSize:12,bold:true,charSpacing:2.2,color:GOLD});
